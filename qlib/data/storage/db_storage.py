...
class DBStorageMixin:
    """FileStorageMixin, applicable to DBXXXStorage
    Subclasses need to have provider_uri, freq, storage_name,  attributes
...
class FileCalendarStorage(DBStorageMixin, CalendarStorage):
